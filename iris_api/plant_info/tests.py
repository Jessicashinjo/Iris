...
class LightSensorMethodTests(TestCase):
    ...
    def test_was_not_published_in_the_future(self):
        time = timezone.now() + datetime.timedelta(days=10)
        future_light_reading = LightSensor(recorded_date=time)
